...
describe('creating posts', () => {
  ...
  test('post without title should fail', async () => {
    const post = {
...
describe('listing posts', () => {
  ...
  test('should list post by tag', async () => {
    const posts = await listPostsByTag('nodejs')
    expect(posts.length).toBe(1)
  })
  test('should list posts by author', async () => {
...
describe('updating posts', () => {
  test('should update the specified prop sucessfully', async () => {
